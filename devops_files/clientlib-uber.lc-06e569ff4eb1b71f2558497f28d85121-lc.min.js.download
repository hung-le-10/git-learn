...
document.addEventListener("DOMContentLoaded", function(event) {
    var activeFeatureFlag = Utils && Utils.activeFeatureFlag("B2C_Cart");
    ...
    var setProductLinks = function(productApiData, callback) {
      var linkEls = document.querySelectorAll(allLinkSelector);
      var isStaging = document.URL.indexOf("-stage.pluralsight") > -1 || document.URL.indexOf("aem-local-author.pluralsight") > -1;
            ...
            [].forEach.call(product.options, function(productOption) {
              if (productOption.marketingId === marketingId) {
                var swapLinkEls = function(pricingOption) {
                  ...
                  var isB2CSku = product.customerType.toLowerCase() === 'individual' && activeFeatureFlag;

                  if ((linkElHref.indexOf("pluralsight.com/checkout") > -1 && !isB2CSku)
